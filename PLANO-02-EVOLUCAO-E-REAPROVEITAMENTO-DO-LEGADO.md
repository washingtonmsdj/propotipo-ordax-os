...
2. Renomear arquivo/pasta, com validação consistente no cliente e no owner da operação. **Estado atual:** implementado no `ordax.file-space/8`, com rename atômico sem sobrescrita, rejeição de symlink/colisão, formulário contextual e regressões de preservação de origem/destino.
