...
class NativeSystemMetricsTests(unittest.TestCase):
    ...
    def test_host_metrics_endpoint_is_loopback_read_only(self):
        ...
        self.assertIn("parsed_path in {SESSION_PATH, FILES_PATH, FILE_CONTENT_PATH, METRICS_PATH, POWER_STATUS_PATH, NETWORK_STATUS_PATH, NETWORK_MANAGEMENT_PATH, UPDATE_HISTORY_PATH}", server)
