...
**Estado:** NOVO/P1 para preferências da Surface; recursos de cursor/leitor do sistema P2 por adapter.
...
| SET-03 | Aumentar texto/reduzir movimento. | Interface continua operável, sem campos cortados. |
